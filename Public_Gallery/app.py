...
def gallery(category):
    ...
    if request.method == 'POST':
        ...
        # Shayari ke liye file optional kar di gayi hai. Agar file nahi hai toh default lag jayega.
        ...
        if is_approved: flash('Uploaded successfully!', 'success')
        else: flash('Sent for Admin approval.', 'success')
        return redirect(url_for('gallery', category=category))
